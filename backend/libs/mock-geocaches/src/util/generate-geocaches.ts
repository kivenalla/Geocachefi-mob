...
import { Geocache, GeoCacheType, Attributes } from "@app/mock-geocaches/interfaces/geocache.interface";
...
export const generateGeoCaches = (amount: number) => {
    ...
    const cache2: Geocache = {
        ...
        difficulty: 2,
        terrain: 5,
        attributes: {abandonedBuildingNo: true}
    }
